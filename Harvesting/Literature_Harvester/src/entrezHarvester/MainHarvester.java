...
//            dataSetDateUp.put("AD_"+dateSuffix, lastUpdateDate);
        ...
        //!FOT -  COMMENT hardcoded query and added a new parameter to settings file!
  //      	dataSetMeSHTerms.put("covid", "COVID-19");
    //    	dataSetDateUp.put("covid", lastUpdateDate); 
      //  	dataSetMeSHTerms.put("coronavirus", "CORONAVIRUS INFECTIONS");
        //	dataSetDateUp.put("coronavirus", lastUpdateDate);
        	
        	//!FOT -  UNCOMMENT
        	String [] mterms = s.getProperty("keywords").toString().split(";");
        	int d=0;
        	for (String term:mterms) {
        		dataSetMeSHTerms.put("NRD"+(++d), term);
        		dataSetDateUp.put("NRD"+d, lastUpdateDate);
        	}
        	
       //FOT - commented
 //       	String term = s.getProperty("keywords").toString();
  //          dataSetMeSHTerms.put("AD", term);
    //        dataSetDateUp.put("AD", lastUpdateDate);
        ...
        for(String dataSetId : dataSetIds){
            ...
            if(dataSetDateUp.get(dataSetId) != null){
                ...
                //System.out.println("@@@@@@@@@@@@@@@@lastUpdate for "+dataSetId+": "+lastUpdate);
            } else{// Else, use a default minimum value
                lastUpdate = "1900/01/01";
            }
            //System.out.println("@@@@@@@@@@@@@@@@querying for MESH TERM: "+meshTerm+" from date: "+lastUpdate);    
